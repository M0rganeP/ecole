...
class EvaluationController extends AbstractController
{
    ...
    {
        return $this->render('evaluation/index.html.twig', ['evaluations' => $evaluationRepository->findAll()]);
    }
    ...
    {
        return $this->render('evaluation/show.html.twig', ['evaluation' => $evaluation]);
    }
    ...
    public function edit(Request $request, Evaluation $evaluation): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('evaluation_index', ['id' => $evaluation->getId()]);
        }
