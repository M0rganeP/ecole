...
class EnseignantController extends AbstractController
{
    ...
    {
        return $this->render('enseignant/index.html.twig', ['enseignants' => $enseignantRepository->findAll()]);
    }
    ...
    public function edit(Request $request, Enseignant $enseignant): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('enseignant_index', ['id' => $enseignant->getId()]);
        }
