...
class MatiereController extends AbstractController
{
    ...
    {
        return $this->render('matiere/index.html.twig', ['matieres' => $matiereRepository->findAll()]);
    }
    ...
    {
        return $this->render('matiere/show.html.twig', ['matiere' => $matiere]);
    }
    ...
    public function edit(Request $request, Matiere $matiere): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('matiere_index', ['id' => $matiere->getId()]);
        }
